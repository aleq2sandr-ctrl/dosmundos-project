...
const EmptyState = ({ currentLanguage, isLoading = false }) => {
  // Map of language codes to proper locale keys
  ...
  const languageKey = languageKeyMap[currentLanguage] || 'languageRussian';
    ...
    <div className="text-center py-12 animate-fade-in-up">
      {isLoading ? (
        ...
        <>
          ...
          <p className="mt-4 text-lg text-slate-300">
            {getLocaleString('noEpisodesFoundForLanguage', currentLanguage, { language: getLocaleString(languageKey, currentLanguage) })}
          </p>
