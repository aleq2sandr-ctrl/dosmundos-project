    ...
    <div className="relative flex items-center justify-center mb-3 sm:mb-4">
      {!isReadingMode && (
        onNavigateBack ? (
          ...
          <Link to={`/${langPrefix}/episodes`} className="absolute left-0 top-1/2 -translate-y-1/2 p-1 rounded-md hover:bg-white/10 transition-colors shrink-0" aria-label={getLocaleString('backToEpisodes', currentLanguage)}>
