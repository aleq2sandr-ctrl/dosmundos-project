/**
 * Script to transcribe 2026-02-18 audio files using AssemblyAI
 * 
 * Usage: node scripts/transcribe-2026-02-18.cjs
 */
...
async function main() {
  ...
  console.log('AssemblyAI Transcription Script for 2026-02-18');
  console.log('='.repeat(60));
